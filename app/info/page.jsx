                ...
                <div className="Infoer">
                    ...
                    <div className="InfoView">
                        <div className="InfoBio animate-on-scroll" data-anim="left">
                            ...
                            <p>His multidisciplinary <a href="/work">skill's</a> set allows him to work across the full creative pipeline — from concept, design, and code to motion and sound. Whether it’s a self-learning interface, an AI-driven web experience, or a cinematic visualization, Murtaza aims to humanize the digital process. His approach emphasizes empathy, precision, and a fascination with the philosophical relationship between humans and intelligent systems.</p>
